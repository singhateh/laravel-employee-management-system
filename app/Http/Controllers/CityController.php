...
class CityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->intended('system-management/city')->with('success','City Created Successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->intended('system-management/city')->with('success','City Updated Successfully!');
    }
    ...
    public function destroy($id)
    {
        City::where('id', $id)->delete();
         return redirect()->intended('system-management/city')->with('success','City Deleted Successfully!');
    }
