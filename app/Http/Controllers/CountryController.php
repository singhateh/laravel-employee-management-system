...
class CountryController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->intended('system-management/country')->with('success','Country Updated Successfully!');
    }
    ...
    public function destroy($id)
    {
        Country::where('id', $id)->delete();
         return redirect()->intended('system-management/country')->with('success','Country Deleted Successfully!');
    }
